...
void about (GtkWidget *widget, gpointer data)
{
    ...
    logo = gdk_pixbuf_new_from_file (PACKAGE_DATADIR "/gtkballs/gtkballs-logo.png", NULL);

    w = g_object_new (GTK_TYPE_ABOUT_DIALOG,
                      "version",      VERSION,
                      "program-name", PACKAGE_NAME,
                      "copyright",    "Copyright (C) 1998-2022",
                      "comments",     "GtkBalls is a Clone of Lines - logic game about balls",
